...
mod surrealdb_tests {
    ...
    fn test_find_locations_large_limit() {
        ...
        // Fixture has 44 total clauses
        assert_eq!(locations.len(), 44, "Should return all locations");
    }
    ...
    fn test_find_locations_regex_dot_star() {
        ...
        // Should find all 44 locations
        assert_eq!(locations.len(), 44, "Should find exactly 44 locations");
    }
