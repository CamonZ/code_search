...
#[command(after_help = "\
Examples:
  code_search code reverse-trace MyApp.Repo get           # Who ultimately calls Repo.get?
  code_search code reverse-trace Ecto.Repo insert --depth 10  # Deeper traversal
  code_search code reverse-trace -r 'MyApp\\..*' 'handle_.*'  # Regex pattern
")]
